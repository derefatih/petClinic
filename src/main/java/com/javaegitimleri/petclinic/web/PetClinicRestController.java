...
public class PetClinicRestController {
	...
	*/
	...
	@RequestMapping(method=RequestMethod.GET, value="/ownerByFirstName")
	public ResponseEntity<List<Owner>> getOwnerByFirstName(@RequestParam("fn") String firstName){
		List<Owner> owners=petClinicService.findOwnersByFirstName(firstName);
		return ResponseEntity.ok(owners);
	}
